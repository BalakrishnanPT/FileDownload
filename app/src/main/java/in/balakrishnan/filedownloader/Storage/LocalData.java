package in.balakrishnan.filedownloader.Storage;

import android.content.Context;
import android.content.SharedPreferences;

import in.balakrishnan.filedownloader.AppConstants;
...
public class LocalData
{
    ...
    {
        this.appSharedPrefs = context.getSharedPreferences(AppConstants.APP_SHARED_PREFS, Context.MODE_PRIVATE);
