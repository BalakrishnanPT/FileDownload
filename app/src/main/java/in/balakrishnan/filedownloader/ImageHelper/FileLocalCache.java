...
import in.balakrishnan.filedownloader.Storage.StorageHelper;
...
public class FileLocalCache {
    ...
    public FileLocalCache(Context context, StorageType type) {
        this.context = context;
        this.type = type;
        checkValue();
    }

    public FileLocalCache(Context context, StorageType type, boolean onCreatePermissionCheck) {
        this.context = context;
        this.type = type;
    ...
    public boolean isImageAvailable(String bucketName, String file_name) {
     ...
     * @return
     */
    public boolean isImageAvailable(String bucketName, String uniqueID, String file_name) {
        Log.d("FileLocalCache", "checkImageAvailability: " + file_name);
     ...
     * @return
     */
    public boolean storeImage(String bucket, String uniqueID, String file_name, Uri fileUri) {
        Bitmap bitmap = BitmapFactory.decodeFile(fileUri.getPath());
        return createImageFromBitmap(bitmap, bucket, file_name);
    }

    public boolean createImageFromBitmap(Bitmap bmp, String bucket, String fileName) {
     ...
     * @return
     */
    public boolean createImageFromBitmap(Bitmap bmp, String bucket, String uniqueID, String fileName) {
     ...
     * @return
     */
    public File createFile(String bucket, String uniqueID, String fileName) {
        if (isAvailable()) {
            return new File(getFile(bucket, uniqueID), getFilteredFileName(fileName));
        }
        return null;
    }

    public Bitmap getImage(String bucketName, String file_name) {
     ...
     * @return
     */
    public Bitmap getImage(String bucketName, String uniqueID, String file_name) {
        if (isAvailable()) {
            File file = new File(getFile(bucketName, uniqueID), getFilteredFileName(file_name));
     ...
     * @return
     */
    public File getFile(String bucketName, String uniqueID, String file_name) {
        if (isAvailable()) {
            File file = new File(getFile(bucketName, uniqueID), getFilteredFileName(file_name));
     ...
     * @param file_name  Name of the file
     */
    public void removeImage(String bucketName, String file_name) {
    ...
    public File getFilePath(String bucket) {
        return getFilePath(bucket, "");
    }

    public File getFilePath(String bucket, String uniqueID) {
        String bucketName = (bucket) + uniqueID;
    ...
    public File getFile(String bucketName) {
        return getFile(bucketName, "");
    }

    public File getFile(String bucketName, String uniqueID) {
    ...
    public boolean isAvailable() {
        if (type == StorageType.CONTEXT_WRAPPER || type == StorageType.INTERNAL_FILE_DIR || type == StorageType.EXTERNAL_FILE_DIR)
            return true;
        else
